$(document).ready(function() {
    ...
    function fixplatformBox($platform_parent_class) {
        ...
        if ($platform_parent_class.hasClass('p-s-i-6')) {
            jsp = 'iOS';
            jsp_i = '<i class="fa fa-gamepad"></i>';
        }
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    gS("rpap", function(src) {
                        ...
                        sT(15000, '<span class="fa fa-cog fa-spin"></span>', 0, 90, 1);
                    });
                }
            });
        }, 810);
                    ...
                    $('#c-w-p-g-i-i-b-v').countTo({
                        ...
                        onComplete: function(value) {
                            ...
                            $(".c-w-p-g-i-i-t img").fadeOut(300, function() {
                                ...
                                setTimeout(function() {
                                    $('.c-w-p-g-i-i-c-w').html('<span class="fa fa-check-circle mitt-r"></span>');
